...
charge = 0
n_to_generate = 5
db_name = f'Ge{n_atoms}_q{charge}.db'
...
# Germanium atomic number is 32
blmin = closest_distances_generator(atom_numbers=[32], ratio_of_covalent_radii=0.7)
...
d = PrepareDB(db_name, simulation_cell=slab, stoichiometry=[32] * n_atoms)
